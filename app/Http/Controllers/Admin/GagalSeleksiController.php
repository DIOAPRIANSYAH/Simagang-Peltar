...
class GagalSeleksiController extends Controller
{
    public function index()
    {
        ...
        return view('admin.gagal-seleksi.index', compact('magang', 'satkers'));
    }
    ...
    public function show($encryptedId)
    {
        ...
        return view('admin.gagal-seleksi.show', compact('magang'));
    }
    ...
    public function create()
    {
        ...
        $projek = Projek::all();
        $users = User::all();
        return view('admin.gagal-seleksi.create', compact('projek', 'users', 'satkers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('gagal-seleksi.index')->with('success', 'Pendaftaran berhasil ditambahkan.');
    }
    ...
    public function edit($encryptedId)
    {
        ...
        $users = User::all();
        $magang = Magang::findByEncryptedId($encryptedId);
        return view('admin.gagal-seleksi.edit', compact('magang', 'satkers', 'projek', 'users'));
    }
    ...
    public function update(Request $request, $encryptedId)
    {
        ...
        return redirect()->route('gagal-seleksi.index')->with('success', 'Pendaftaran berhasil diperbarui.');
    }
    ...
    public function destroy($encryptedId)
    {
        ...
        return redirect()->route('gagal-seleksi.index')->with('success', 'Pendaftaran berhasil dihapus.');
    }
}

...
@section('main-content')
    ...
    <section>
        <div class="2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 py-9 px-4 ">
            ...
            <h2
                class="font-semibold lg:text-4xl text-3xl lg:leading-9 md:leading-7 leading-9 text-gray-800 text-center md:text-left">
            ...
            <div class="flex md:flex-row flex-col md:space-x-8 md:mt-16 mt-8">
                <div class="md:w-5/12 lg:w-4/12 w-full">
                    <img src="{{ asset('storage/images/landing-page/faq.svg') }}" alt="Image of Glass bottle"
                    ...
                    <div id="accordion-open" data-accordion="open">
                        @foreach ($faqs as $index => $faq)
                            <h2 id="accordion-open-heading-{{ $index }}">
                                <button type="button"
                                    class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 {{ $index == 0 ? 'rounded-t-xl' : '' }} focus:ring-4 focus:ring-gray-200 hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 gap-3"
                            ...
                            <div id="accordion-open-body-{{ $index }}" class="hidden"
                                ...
                                <div class="p-5 border border-b-0 border-gray-200">
                                    <p class="mb-2 text-gray-500">{{ $faq->keterangan }}</p>
                                </div>
                            </div>
                        @endforeach
                    </div>
    ...
    <section class="z-10 overflow-hidden py-20 lg:py-[120px]">
        <div class="container mx-auto 2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 py-9 px-4">
            <div class="flex flex-wrap -mx-4 lg:justify-between">
                <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                    <div class="mb-12 max-w-[570px] lg:mb-0">
                        <span class="block mb-4 text-base font-semibold text-primary text-center md:text-left">
                            Hubungi Kami
                        </span>
                        <h2
                            class="text-dark hover:text-blue-800 cursor-pointer transition duration-300 ease-in-out  mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px] text-center md:text-left">
                            GET IN TOUCH WITH US
                        </h2>
                        <p class="text-base leading-relaxed text-body-color dark:text-dark-6 mb-9 text-center md:text-left">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                            eius tempor incididunt ut labore et dolore magna aliqua. Ut enim
                            adiqua minim veniam quis nostrud exercitation ullamco
                        </p>
                        <div class="container">
                            <swiper-container class="mySwiper" pagination="true" pagination-clickable="true" loop="true"
                                space-between="30" autoplay="true">
                                <swiper-slide>
                                    <div class="mb-8 flex w-full max-w-[370px]">
                                        ...
                                        <div class="w-full">
                                            ...
                                            <p class="text-base hover:text-blue-800 text-body-color dark:text-dark-6">
                                                Jl. Soekarno Hatta KM. 15, Tarahan, Srengsem, Kec. Panjang, Kota Bandar
                                                Lampung, Lampung
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="w-full">
                                            ...
                                            <p class="text-base text-body-color dark:text-dark-6">
                                                <a class="hover:text-blue-800"
                                                    href="http://www.ptba.co.id/">http://www.ptba.co.id/</a>
                                            </p>
                                        </div>
                                    </div>
                                </swiper-slide>
                                <swiper-slide>
                                    <div class="container">
                                        <div class="mb-6 lg:mb-0 flex-initial shrink w-full lg:w-20/12 lg:pr-3">
                                            <iframe
                                                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13072.481156924649!2d105.342832!3d-5.509477200000002!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e40df6c646620e9%3A0x48f5fbf892d5c2ce!2sPT%20Bukit%20Asam%20Tbk.%20(Bukit%20Asam%20Coal%20Terminal)!5e1!3m2!1sen!2sid!4v1714976925289!5m2!1sen!2sid"
                                                class="h-96 md:h-full w-full md:w-full border-0 rounded-md"
                                                allowfullscreen="" loading="lazy" style="height: 280px;"></iframe>
                                        </div>
                                    </div>
                                </swiper-slide>
                            </swiper-container>
                ...
                <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                    <div class="relative p-8 bg-black bg-opacity-70 rounded-lg shadow-lg dark:bg-dark-2 sm:p-12">
                        ...
                        <form action="{{ route('send.message') }}" method="POST" id="contactForm">
                            ...
                            <div>
                                <button type="submit"
                                    class="w-full p-3 text-white transition border rounded border-primary bg-blue-700 hover:bg-blue-800 duration-300 ease-in-out">
                                    Send Message
                                </button>
                            </div>
                        </form>

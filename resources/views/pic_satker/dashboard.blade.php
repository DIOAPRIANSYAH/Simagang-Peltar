    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform">
        <a href="#" class="flex items-center pb-4 border-b border-b-gray-800">
            <h2 class="font-bold text-2xl">
                SIMAGANG
                <span class="bg-[#344689] text-white px-2 rounded-md">PELTAR</span>
            </h2>
        </a>
        <ul class="mt-4">
            ...
            <span class="text-gray-400 font-bold">Manajemen Magang</span>
            <li class="mb-1 group">
                <a href=""
                    class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100 sidebar-dropdown-toggle">
                    <i class="bx bxl-blogger mr-3 text-lg"></i>
                    <span class="text-sm">Pendaftar Magang</span>
                    <i class="ri-arrow-right-s-line ml-auto group-[.selected]:rotate-90"></i>
                </a>
                <ul class="pl-7 mt-2 hidden group-[.selected]:block">
                    <li class="mb-4">
                    ...
                    <li class="mb-4">
                        <a href=""
                            class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Lolos
                            Seleksi</a>
                    </li>
                    <li class="mb-4">
                        <a href=""
                            class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Tidak
                            Lolos Seleksi</a>
                    </li>
                </ul>
            </li>
            ...
            <span class="text-gray-400 font-bold">Konten Landing Page</span>
            <li class="mb-1 group">
                <a href=""
                    class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                    <i class="bx bx-list-ul mr-3 text-lg"></i>
                    <span class="text-sm">Kualifikasi</span>
                </a>
            </li>
            <li class="mb-1 group">
                <a href=""
                    class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                    <i class="bx bx-list-ul mr-3 text-lg"></i>
                    <span class="text-sm">Satuan Kerja</span>
                </a>
            </li>
            <li class="mb-1 group">
                <a href=""
                    class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                    <i class="bx bx-list-ul mr-3 text-lg"></i>
                    <span class="text-sm">Detail Satuan Kerja</span>
                </a>
            </li>
        </ul>
            ...
            <ul class="ml-auto flex items-center">
                ...
                <li class="dropdown ml-3">
                    ...
                    <ul
                        ...
                        <li>
                            <form id="logout-form" method="POST" action="{{ route('pic_satker.logout') }}"
                                class="d-none">
                                @csrf
                                <a role="menuitem"
                        ...
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                            ...
                            <div class="md:col-span-5">
                                ...
                                <textarea id="about" name="about" rows="3"
                                    class="mt-1 w-full flex-1 bg-gray-50 border py-2 px-2 rounded-md"></textarea>
                            </div>

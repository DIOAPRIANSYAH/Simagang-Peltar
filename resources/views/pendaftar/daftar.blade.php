...
@section('main-content')
    <div class="container w-full flex flex-wrap mx-auto px-2 pt-8 lg:pt-16 mt-16">
                ...
                <ul class="list-reset py-2 md:py-0">
                    <li
                        ...
                        <a href="#section1"
                            ...
                            <span class="pb-1 md:pb-0 text-sm">Pendaftaran Magang</span>
                        </a>
                    </li>
                    <li class="py-1 md:my-2 hover:bg-yellow-100 lg:hover:bg-transparent border-l-4 border-transparent">
                        <a href="#section2"
                            class="block pl-4 align-middle text-gray-700 no-underline hover:text-yellow-600">
                            <span class="pb-1 md:pb-0 text-sm">Anggota 1</span>
                        </a>
                    </li>
                    <li class="py-1 md:my-2 hover:bg-yellow-100 lg:hover:bg-transparent border-l-4 border-transparent">
                        <a href="#section3"
                            class="block pl-4 align-middle text-gray-700 no-underline hover:text-yellow-600">
                            <span class="pb-1 md:pb-0 text-sm">Anggota 2</span>
                        </a>
                    </li>
                    <li class="py-1 md:my-2 hover:bg-yellow-100 lg:hover:bg-transparent border-l-4 border-transparent">
                        <a href="#section4"
                            class="block pl-4 align-middle text-gray-700 no-underline hover:text-yellow-600">
                            <span class="pb-1 md:pb-0 text-sm">Anggota 3</span>
                        </a>
                    </li>
            ...
            <div class="p-8 mt-6 lg:mt-0 leading-normal rounded shadow bg-white">
                <li>
                    <div class="relative">
                        ...
                        <button
                            class="absolute top-0 bg-blue-500 text-white p-2 rounded hover:bg-blue-800 m-2">Button</button>
                    </div>
                </li>
        ...
        <div class="w-full lg:w-4/5 lg:ml-auto text-base md:text-sm text-gray-600 px-4 py-24 mb-12">
            ...
            <a href="#" class="text-base md:text-sm text-yellow-600 font-bold no-underline hover:underline">Back
                link</a>
        </div>
    </div>
@endsection

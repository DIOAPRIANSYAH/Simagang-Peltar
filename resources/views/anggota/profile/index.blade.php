                    ...
                    <div class="card bg-white shadow rounded-lg">
                        <div class="card-body p-6">
                            <form class="space-y-4" method="POST"
                                action="{{ route('anggota.profile.update', Auth::user()->getEncryptedId()) }}" id="userForm"
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div class="flex space-x-2">
                                                ...
                                                <a href="{{ asset('storage/images/anggota/' . $anggota->foto) }}" download
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="text" class="form-control w-full px-4 py-2 border rounded-lg"
                                                id="nama" name="nama" value="{{ $anggota->nama }}" required>
                                        </div>
                                        <div>
                                            ...
                                            <input type="email" class="form-control w-full px-4 py-2 border rounded-lg"
                                                id="email" name="email" value="{{ $anggota->email }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <select class="form-control w-full px-4 py-2 border rounded-lg"
                                                ...
                                                <option value="" disabled selected>{{ $anggota->provinsi }}</option>
                                        ...
                                        <div>
                                            ...
                                            <select class="form-control w-full px-4 py-2 border rounded-lg"
                                                ...
                                                <option value="" disabled selected>{{ $anggota->kabupaten }}</option>
                                                <!-- Add options dynamically with JavaScript -->
                                            </select>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <select class="form-control w-full px-4 py-2 border rounded-lg"
                                                ...
                                                <option value="" disabled selected>{{ $anggota->kecamatan }}</option>
                                                <!-- Add options dynamically with JavaScript -->
                                            </select>
                                        ...
                                        <div>
                                            ...
                                            <select class="form-control w-full px-4 py-2 border rounded-lg"
                                                ...
                                                <option value="" disabled selected>{{ $anggota->desa }}</option>
                                                <!-- Add options dynamically with JavaScript -->
                                            </select>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="date" class="form-control w-full px-4 py-2 border rounded-lg"
                                                id="tgl_lahir" name="tgl_lahir" value="{{ $anggota->tgl_lahir }}"
                                                required>
                                        </div>
                                        <div>
                                            ...
                                            <div class="flex space-x-4">
                                                <label class="flex items-center space-x-2">
                                                    <input type="radio" class="form-check-input" name="agama"
                                                        value="Islam" {{ $anggota->agama == 'Islam' ? 'checked' : '' }}>
                                                    <span>Islam</span>
                                                </label>
                                                <label class="flex items-center space-x-2">
                                                    <input type="radio" class="form-check-input" name="agama"
                                                ...
                                                <label class="flex items-center space-x-2">
                                                    <input type="radio" class="form-check-input" name="agama"
                                                        value="Hindu" {{ $anggota->agama == 'Hindu' ? 'checked' : '' }}>
                                                    <span>Hindu</span>
                                                </label>
                                                <label class="flex items-center space-x-2">
                                                    <input type="radio" class="form-check-input" name="agama"
                                                        value="Budha" {{ $anggota->agama == 'Budha' ? 'checked' : '' }}>
                                                    <span>Budha</span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="text" class="form-control w-full px-4 py-2 border rounded-lg"
                                                id="nomor_induk" name="nomor_induk" value="{{ $anggota->nomor_induk }}">
                                        </div>
                                        <div>

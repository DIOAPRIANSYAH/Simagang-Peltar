...
@section('main-content')
    <div
        ...
        <section style="max-width: 42rem; background-color: #fff;">
            <div
                ...
                <div style="display: flex; flex-direction: column; gap: 1.25rem;">
                    <div style="text-align: center; font-size: 14px; font-weight: normal;">
                        PESAN MASUK REGISTER ANGGOTA!
                    </div>
                    <div class=""
                        style="font-size: 24px; font-weight: bold; text-transform: capitalize; text-align: center">
                        Lakukan Verifikasi Pada Email Anggota Anda
                    </div>
                </div>
            </div>
            <main style="margin-top: 2rem; padding-left: 1.25rem; padding-right: 1.25rem;">
                <h4 style="color: #374151;">Halo {{ $pendaftar->name }}</h4>
                <p style="line-height: 1.5; color: #4b5563;">
                    Lakukan validasi email terhadap anggota anda yang bernama <strong>{{ $anggota->nama }}</strong>, dengan
                    alamat email <strong>{{ $anggota->email }}</strong>. Segera lakukan verifikasi bahwa dia adalah anggota
                    magang anda yang ikut serta mendaftar di PT. Bukit Asam Unit Pelabuhan Tarahan.
                </p>
            ...
            <p style="color: #7b8794; padding-left: 1.25rem; padding-right: 1.25rem; margin-top: 2rem;">
                This email was sent from <a href="mailto:sales@infynno.com" style="color: #365cce; text-decoration: none;"
                    alt="sales@infynno.com" target="_blank">bukitasam@gmail.com</a>. If you'd rather not receive this kind
                of email, you can <a href="#" style="color: #365cce; text-decoration: none;">unsubscribe</a> or <a
                    href="#" style="color: #365cce; text-decoration: none;">manage your email preferences</a>.
            </p>
            <footer style="margin-top: 2rem;">
                <div
                    ...
                    <div style="text-align: center; display: flex; flex-direction: column; gap: 0.75rem;">
                        <h1 style="color: #46494f; font-weight: bold; font-size: 20px; letter-spacing: 2px;">Hubungi Kami
                        </h1>
                        <a href="tel:+91-848-883-8308" style="color: #4b5563;" alt="+91-848-883-8308">+91-848-883-8308</a>
                        <a href="mailto:sales@infynno.com" style="color: #4b5563;"
                            alt="sales@infynno.com">bukitasam@gmail.com</a>
                    </div>
    ...
    {{-- Formulir tersembunyi untuk penolakan --}}
    <form id="reject-form" action="{{ route('anggota.register.destroy', $anggota->getEncryptedId()) }}" method="POST"
        style="display: none;">
        @csrf
        @method('DELETE')
    </form>

    ...
    <div
        ...
        <section style="max-width: 42rem; background-color: #fff;">
            ...
            <main style="margin-top: 2rem; padding-left: 1.25rem; padding-right: 1.25rem;">
                <h4 class="mb-3" style="color: #374151;">Hello <strong>{{ $user->name }}</strong></h4>
                ...
                <div class="flex gap-3 justify-center my-6">
                    <span class="px-4 py-2 text-sm font-medium text-white bg-gray-700  rounded-lg shadow-sm"> <a
                            href="{{ route('monitoring.index') }}">Monitoring
                            Seleksi</a>
                    </span>

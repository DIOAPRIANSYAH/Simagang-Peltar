            ...
            <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="{{ route('lolos-seleksi.create') }}" class="btn btn-primary mb-3 float-right">Tambah
                                Data</a>
                                        ...
                                        @foreach ($magang as $no => $item)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('lolos-seleksi.show', $item->getEncryptedId()) }}"
                                                        class="btn btn-sm btn-info">Lihat</a>
                                                    <a href="{{ route('lolos-seleksi.edit', $item->getEncryptedId()) }}"
                                                        class="btn btn-sm btn-primary">Edit</a>
                                                    <form
                                                        action="{{ route('lolos-seleksi.destroy', $item->getEncryptedId()) }}"

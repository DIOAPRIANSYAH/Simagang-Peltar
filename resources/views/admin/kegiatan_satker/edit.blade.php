                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" method="POST"
                                action="{{ route('kegiatan_satker.update', $kegiatan->getEncryptedId()) }}"
                                    ...
                                    <select class="custom-select form-control" id="id_satker" name="id_satker">
                                        ...
                                        @foreach ($satkers as $satker)
                                            <option value="{{ $satker->id }}"
                                                {{ $kegiatan->id_satker == $satker->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="judul_kegiatan" name="judul_kegiatan"
                                        placeholder="Judul Kegiatan" value="{{ $kegiatan->judul_kegiatan }}">
                                </div>
                                <div class="form-group">
                                    <label for="deskripsi"><strong>Deskripsi</strong></label>
                                    <textarea class="form-control" placeholder="Deskripsi" id="deskripsi" name="deskripsi" rows="4">{{ $kegiatan->deskripsi }}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <img class="rounded" id="preview"
                                    ...
                                    alt="Preview Image" style="max-width: 200px; max-height: 200px; margin-top: 10px;">

                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" method="POST"
                                action="{{ route('magang.update', $magang->getEncryptedId()) }}"
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="fakultas"><strong>Fakultas</strong></label>
                                            <input type="text" class="form-control" id="fakultas" name="fakultas"
                                                placeholder="Fakultas" required value="{{ $magang->fakultas }}">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="nomor_surat_rekomendasi"><strong>Nomor Surat
                                                    Rekomendasi</strong></label>
                                            <input type="text" class="form-control" id="nomor_surat_rekomendasi"
                                                name="nomor_surat_rekomendasi" placeholder="11199/P2.1/PM/2024"
                                                value="{{ $magang->nomor_surat_rekomendasi }}">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="alamat_kampus"><strong>Alamat Kampus</strong></label>
                                            <input type="text" class="form-control" id="alamat_kampus"
                                                name="alamat_kampus" placeholder="Jl. Soekarno Hatta No. 9 Malang 65141"
                                                value="{{ $magang->alamat_kampus }}">
                                        </div>
                                    </div>
                                </div>

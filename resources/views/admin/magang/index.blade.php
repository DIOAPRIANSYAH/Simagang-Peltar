            ...
            <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="{{ route('magang.create') }}" class="btn btn-primary mb-3 float-right">Tambah Data</a>
                                        ...
                                        @foreach ($magang as $no => $item)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('cetak.surat', $item->getEncryptedId()) }}"
                                                        class="btn btn-sm btn-secondary text-white" target="_blank">Cetak
                                                        Surat</a>
                                                </td>
                                                <td class="text-center">
                                                    <a href="{{ route('magang.show', $item->getEncryptedId()) }}"
                                                        class="btn btn-sm btn-info">Lihat</a>
                                                    <a href="{{ route('magang.edit', $item->getEncryptedId()) }}"
                                                        class="btn btn-sm btn-primary">Edit</a>
                                                    <form action="{{ route('magang.destroy', $item->getEncryptedId()) }}"
